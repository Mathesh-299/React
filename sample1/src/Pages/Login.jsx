                            ...
                            <div className='h-[60%] w-[35%] flex flex-col justify-start bg-white items-center  shadow-md shadow-purple-800'>
                                ...
                                <div className='w-[100%] h-[91vh] flex  justify-center items-center bg-black/90'>
                                    <form className="w-80 h-[100%] flex flex-col justify-center items-center gap-4 p-4" onSubmit={handleSubmit} >
                                        <input type="text" name="name" id="name" placeholder="Name" className=' w-80 h-[3rem] rounded-sm outline-none active:outline-none focus:border-b-2 hover:border-green-400 bg-[#d1d1d1] hover:bg-white font-bold' required onChange={handleChange} />
                                        <input type="email" name="email" id="email" placeholder="Email" className=' w-80 h-[3rem] rounded-sm  outline-none active:outline-none focus:border-b-2 hover:border-purple-700 font-bold bg-[#d1d1d1] hover:bg-white' required onChange={handleChange} />
                                        <button type="submit" className='submit-btn  w-80 h-[3.5rem] bg-green-700 text-black text-2xl font-sans font-bold flex justify-center items-center rounded-lg hover:bg-white/70'>Submit</button>
